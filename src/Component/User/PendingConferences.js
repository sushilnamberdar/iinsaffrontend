...
const PendingConferences = () => {
    // Sample pending conferences data (10 dummy entries)
    const pendingConferences = [
        {
            id: 1,
        ...
        {
            id: 3,
            userEmail: 'pending3@example.com',
            date: '2024-09-03',
            state: 'Texas',
            city: 'Dallas',
            budget: '$4000',
        ...
        {
            id: 4,
            userEmail: 'pending4@example.com',
            date: '2024-09-04',
            state: 'Florida',
            city: 'Miami',
            budget: '$3500',
        ...
        {
            id: 5,
            userEmail: 'pending5@example.com',
            date: '2024-09-05',
            state: 'Illinois',
            city: 'Chicago',
            budget: '$6000',
        ...
        {
            id: 6,
            userEmail: 'pending6@example.com',
            date: '2024-09-06',
            state: 'Nevada',
            city: 'Las Vegas',
            budget: '$8000',
        ...
        {
            id: 7,
            userEmail: 'pending7@example.com',
            date: '2024-09-07',
            state: 'Georgia',
            city: 'Atlanta',
            budget: '$5000',
        ...
        {
            id: 8,
            userEmail: 'pending8@example.com',
            date: '2024-09-08',
            state: 'Arizona',
            city: 'Phoenix',
            budget: '$2500',
        ...
        {
            id: 9,
            userEmail: 'pending9@example.com',
            date: '2024-09-09',
            state: 'Colorado',
            city: 'Denver',
            budget: '$7000',
        ...
        {
            id: 10,
            userEmail: 'pending10@example.com',
            date: '2024-09-10',
            state: 'Washington',
            city: 'Seattle',
            budget: '$4000',
    ...
    const totalPages = Math.ceil(pendingConferences.length / conferencesPerPage);
    ...
    const currentConferences = pendingConferences.slice(indexOfFirstConference, indexOfLastConference);
    ...
    return (
        <div className="p-5 bg-gray-50 rounded-lg shadow-md bg-gradient-to-r from-[#ecf5ff] to-[#d1edc4]">
            <div className="flex flex-col md:flex-row items-center justify-between mb-4">
                <h5 className="text-xl font-semibold">Pending Conferences</h5>
