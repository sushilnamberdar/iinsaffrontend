...
const SocialIcons = () => {
    return (
        <div className="social-container" data-aos="flip-up" data-aos-anchor="#trigger-element">
            <div className="card">
                <div className="front">
                    <svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" fill="currentColor" className="bi bi-share-fill" viewBox="0 0 16 16">
